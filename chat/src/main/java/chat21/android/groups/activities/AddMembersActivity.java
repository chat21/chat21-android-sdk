...
public class AddMembersActivity extends AppCompatActivity implements
        OnItemClickedListener<IChatUser>,
...
//    }
    ...
    private void updateContactListAdapter(List<IChatUser> contactList) {
        ...
        if (mContactListAdapter == null) {
            ...
            mContactListAdapter.setOnItemClickedListener(this);
...
//        initAlreadyAddedContacts(contactList);
    ...
    private void updateSelectedContactListAdapter(List<IChatUser> selectedList, int position) {
        ...
        if (mSelectedContactListAdapter == null) {
            ...
            mSelectedContactListAdapter.addOnRemoveClickListener(this);
    ...
    @Override
    public void onItemClickedListener(IChatUser item, int position) {
    ...
    public class ContactsListAdapter extends
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    onItemClickedListener.onItemClickedListener(mValues.get(position), position);
                }
            });
        }
        ...
        public void setOnItemClickedListener(OnItemClickedListener<IChatUser> listener) {
...
//                mAlreadyAddedIcon.setVisibility(View.GONE);
    ...
    public class SelectedContactListAdapter extends AbstractRecyclerAdapter<IChatUser,
            SelectedContactListAdapter.ViewHolder> {
        private final String TAG = SelectedContactListAdapter.class.getName();
        ...
        public SelectedContactListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new SelectedContactListAdapter.ViewHolder(view);
        }

        @Override
        public void onBindViewHolder(SelectedContactListAdapter.ViewHolder holder, final int position) {
            ...
            onRemoveClickListener(holder, position);
        }

        private void loadProfileImage(SelectedContactListAdapter.ViewHolder holder, IChatUser contact) {
        ...
        private void onRemoveClickListener(SelectedContactListAdapter.ViewHolder holder, final int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    onRemoveClickListener.onRemoveClickListener(returnedPosition);
                }
            });
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater()
                .inflate(R.menu.menu_activity_add_members, menu);
    ...
    private Group getGroup() {
        ...
        return (Group) getIntent()
                .getExtras()
                .getSerializable(ChatManager._INTENT_BUNDLE_GROUP);
    }

    private String getGroupId() {
        return getIntent()
                .getExtras()
                .getString(ChatManager._INTENT_EXTRAS_GROUP_ID);
    }

    private String getParentActivity() {
        return getIntent()
                .getExtras()
                .getString(ChatManager._INTENT_EXTRAS_PARENT_ACTIVITY);
    }
    ...
    private void uploadGroup(String groupId, final Group group) {
        ...
        if (group.getMembers().size() > 0) {
            if (!StringUtils.isValid(groupId)) {
                ...
                mNodeDAO.getNodeGroups().push().setValue(group, new DatabaseReference.CompletionListener() {
                    @Override
                ...
                mNodeDAO.getGroupById(groupId).child("members").setValue(group.getMembers(),
    ...
    private void createConversationsOnFirebaseAsync(String groupId, Group group) {
        ...
        for (Map.Entry<String, Integer> entry : group.getMembers().entrySet()) {
            ...
            ConversationUtils.uploadConversationOnFirebase(this, groupId, memberId, conversation);
        }
    }
    ...
    private void startNextActivity(String groupId) {
        ...
        if (callingIntent != null) {
            callingIntent.putExtra(ChatManager._INTENT_EXTRAS_GROUP_ID, groupId);
